        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="rights[]" id="manage_users" value="manage_users" {{ old('manage_users') ? 'checked' : '' }}>
                    <label class="form-check-label" for="manage_users">
                        Manage Users
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="rights[]" id="edit_feeds" value="edit_feeds" {{ old('edit_feeds') ? 'checked' : '' }}>
